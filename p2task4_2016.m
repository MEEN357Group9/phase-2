...
subplot(3,1,1)
plot(T4,X4(:,4), 'g')
title('Displacements: Rear Axle of a Car Hitting a Tar Strip')
xlabel('Time [s]')
ylabel('Displacement [ft]')
...
subplot(3,1,2)
plot( T4,V4(:,4), 'g')
title('Velocities: Rear Axle of a Car Hitting a Tar Strip')
xlabel('Time [s]')
ylabel('Velocity [ft/s]')
legend('1/2 car 4 DOF', 'location', 'northeast')
...
subplot(3,1,3)
plot(T4,A4(:,4), 'g')
title('Accelerations: Rear Axle of a Car Hitting a Tar Strip')
xlabel('Time [s]')
ylabel('Acceleration [ft/s^2]')
legend('1/2 car 4 DOF', 'location', 'northeast')
